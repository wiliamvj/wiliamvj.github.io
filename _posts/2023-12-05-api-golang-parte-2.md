...
Vamos iniciar a configuração do sqlc, também já fiz post sobre [como utilizar o go com sqlc](https://wiliamvj.com/posts/golang-sqlc/){:target="\_blank"}.
...
![interface error](/commons/posts/2023-12-05-api-golang-parte-2/ofhi78F34fghjHLaqSD.png){: .normal }
...
Para finalizar a parte 2, precisamos criar uma função que criar nossa conexão com o banco de dados, mas o banco de dados precisa consumir as credenciais salva no nosso `.env` para isso vamos utilizar o [viper](https://github.com/spf13/viper){:target="\_blank"}, não vou me aprofundar no viper, mas você pode entender melhor nesse [post](https://aprendagolang.com.br/2021/11/04/carregando-configuracoes-com-viper/){:target="\_blank"}.
...
Precisamos criar nossas rotas, vamos usar o [Go Chi](https://github.com/go-chi/chi){:target="\_blank"} para isso,
